            ...
            <CardFooter className='flex justify-end gap-2'>
                ...
                <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
                    <AlertDialogTrigger asChild>
                        <Button variant={'destructive'}  disabled={isDeletion}>
                            {isDeletion ? <Loader2 className="size-4 animate-spin" /> :
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                This action cannot be undone. This will permanently delete your notebook and all of its notes.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
